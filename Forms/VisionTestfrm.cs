...
namespace DVLDProject.Forms
{
    ...
    public partial class VisionTestfrm : Form
    {
        ...
        public VisionTestfrm(int LDLAppID, ClsApplication applicant, string FullName, string Type, string Status, string NationNo
)
        {
            InitializeComponent();
        ...
        private void VisionTestfrm_Load(object sender, EventArgs e)
        {
            _dtTestAppointments = ClsTestAppointments.GetAppointmentsWithLDLAppID(LDLAppId, TestTypeID);
